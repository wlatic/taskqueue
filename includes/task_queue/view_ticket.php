...
<script type="text/javascript">
    ...
    location.href = "<?php echo get_page_link(get_page_by_title('Task Queue Tickets')); ?>";
</script>
<?php } else { ?>
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="action" id="action" value="add_reply">
                ...
                <div class="section section-blog-info">
                    <div class="row">
                        <div class="col-md-12 ml-auto mr-auto">
                            <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo get_page_link(get_page_by_title('Task Queue Tickets')); ?>" title="Back"><i class="fa fa-chevron-left"></i> Back to list</a>
